module.exports = {
  ...
  rules: {
    ...
    'vue/require-default-prop': 'off', // 此规则强制执行props语句包含类型定义
    'vue/custom-event-name-casing': 0,
    'vue/no-mutating-props': 0,
    'vue/attribute-hyphenation': 'off', // 此规则强制在Vue模板中的自定义组件上使用连字符属性名称
    ...
    "vue/multiline-html-element-content-newline":"off", // 此规则在多行元素的内容之前和之后强制行中断
    "vue/name-property-casing": ["error", "PascalCase"], // Vue组件中的name属性强制使用特定的大小
    "vue/no-v-html": "off",
