<template>
  <div class="app-container">
    ...
    <div :key="key" style="margin-top:30px;">
      <div>
        <span v-permission="['管理员']" class="permission-alert">
          Only
          <el-tag class="permission-tag" size="small">管理员</el-tag> can see this
        </span>
        <el-tag v-permission="['管理员']" class="permission-sourceCode" type="info">
          v-permission="['管理员']"
        </el-tag>
      </div>
      ...
      <div>
        <span v-permission="['editor']" class="permission-alert">
          Only
          <el-tag class="permission-tag" size="small">用户</el-tag> can see this
        </span>
